...
describe('ProfileService', () => {
	...
	it('findOneById => should find a profile by a given id and return its data', async () => {
		...
		expect(mockRepository.findOne).toHaveBeenCalledWith(findProfileByProfileIdQuery(id));
	...
	it('findOneByUsername => should find a profile by a given username and return its data', async () => {
		...
		// assert
		expect(mockRepository.findOne).toHaveBeenCalled();
		expect(mockRepository.findOne).toHaveBeenCalledWith(findProfileByUsernameQuery(username));
